...
This work is archived at arXiv:2603.25774 (\href{https://doi.org/10.48550/arXiv.2603.25774}{doi:10.48550/arXiv.2603.25774}).
The companion Python package \texttt{cqec} (v0.1.0) and reproduction scripts are released under the MIT license; the package implements all four catalyst preparation strategies and the variational CQEC recovery circuit.
A single command (\texttt{python scripts/reproduce\_paper.py}, $\sim$35\,s) reproduces the key claims of Figs.~\ref{fig:threshold}, Tables~\ref{tab:standard_depol}, \ref{tab:dd_pipeline}, \ref{tab:finite_n_actual}, and \ref{tab:entangled} from the manuscript.
