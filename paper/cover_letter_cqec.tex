...
\begin{enumerate}
\item \emph{CPTP joint-channel validation.} A genuinely linear, completely positive, exactly covariant recovery channel ($\|[U,H]\| = 0$; linearity residual $< 4 \times 10^{-16}$, machine precision; Choi-positive to numerical tolerance) improves fidelity under dephasing at $d = 4$ from $0.54$ to $0.77$; a target-swap control shows the recovery is a property of the channel, not of injected target information.
